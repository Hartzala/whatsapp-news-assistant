...
import { registerWhatsAppWebhooks } from "../webhooks/whatsappHandler";
import twilioWebhook from "../webhooks/twilioWebhook";
...
async function startServer() {
  ...
  // In production, use the PORT env variable directly (Railway requirement)
